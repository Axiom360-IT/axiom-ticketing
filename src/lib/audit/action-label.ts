...
const ACTION_LABELS: Record<string, string> = {
  ...
  "ticket.category_change": "Changed the category",
  "ticket.type_change": "Changed the type",
  "ticket.customer_change": "Changed the customer",
  "category.create": "Created a category",
  "category.update": "Updated a category",
  "category.set_default": "Set the default category",
  "category.delete": "Deleted a category",
  "ticket_type.create": "Created a ticket type",
  "ticket_type.update": "Updated a ticket type",
  "ticket_type.set_default": "Set the default ticket type",
