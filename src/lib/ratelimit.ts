...
export const ratelimits = {
  ...
  /** Bulk invite/reset resend from the Users list: 10 batches per admin per
   *  hour. Gates the BATCH itself, not the individual sends within it. */
  bulkResendInvites: makeLimiter(10, "1 h"),
