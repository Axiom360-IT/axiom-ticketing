...
import { VendorTable, type VendorRow } from "@/components/settings/vendor-table";
import {
  Pagination,
  parsePage,
  parsePageSize,
...
import { listVendorsForAdmin } from "@/app/actions/vendors";
...
export default async function VendorsPage({
  ...
  const all: VendorRow[] = await listVendorsForAdmin();
